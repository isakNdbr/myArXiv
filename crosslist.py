"""
Adapted from
http://arxiv.org/help/api/examples/python_arXiv_parsing_example.txt, https://github.com/mpi-astronomy/XarXiv/blob/main/crosslist.py
...
end_date = oneweek_ago.strftime("%Y%m%d") + "2000"
